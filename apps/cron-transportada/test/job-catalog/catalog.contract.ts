...
import { DISTRIBUTION_INELIGIBILITY_REASONS } from '../../src/nfe-distribution-pull/domain/distribution-eligibility.policy.js'
import {
  JOB_CATALOG,
...
describe('cron job catalog', () => {
  ...
  /** O vocabulário da distribuição é o que a policy de elegibilidade desta app já publica. */
  test('borrows the distribution vocabulary from the eligibility policy of this app', () => {
