...
import type { DfeItem } from '@adatechnology/fiscal-provider'
...
export function createNfeDistributionPersistenceAdapter(
  ...
  return {
    ...
    async persistPage(input): Promise<{
      ...
      return { acceptedCount: result.acceptedCount, duplicatedCount: result.duplicatedCount }
    },
  }
}
