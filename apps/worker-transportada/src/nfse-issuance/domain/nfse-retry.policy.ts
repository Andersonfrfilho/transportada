 ...
 *
 * Cópia por valor de `nfse-invoices/domain/nfse-retry.policy.ts` da API, que é quem declara os
 * defaults e os limites das colunas `nfse_retry_*` — as apps não importam código uma da outra.
 */
