...
type BuildCteRabbitMqTopologyParams = {
  readonly queuePrefix: string
}

export function buildCteIssuanceRabbitMqTopology(
  params: BuildCteRabbitMqTopologyParams,
): RabbitMqTopology {
  const routePrefix = `${params.queuePrefix}.cte-issuance.v1`
