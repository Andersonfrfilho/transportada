...
export const fleetVehicles = pgTable('fleet_vehicles', {
  ...
  role: text().notNull(),
  tareWeightKg: bigint('tare_weight_kg', { mode: 'bigint' }).notNull(),
  capacityKg: bigint('capacity_kg', { mode: 'bigint' }).notNull(),
  capacityM3: bigint('capacity_m3', { mode: 'bigint' }).notNull(),
