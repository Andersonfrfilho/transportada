...
import type { InvitationDeliveryClaimedEntry } from '../infrastructure/drizzle-invitation-delivery-outbox.repository.js'

type Clock = { now(): Date }

type Publisher = {
  publish(params: { readonly envelope: InvitationDeliveryEnvelopeV1 }): Promise<void>
}
...
export class InvitationDeliveryOutboxRelayService {
      ...
      try {
        await this.#publisher.publish({
          envelope: {
            ...
            payload: { invitationId: entry.invitationId, userId: entry.userId },
