 ...
 * staging isso apagava o contexto de cada mensagem consumida. A mesma regra
 * vive nas outras apps implantadas, cada uma com o seu contrato.
 */
...
describe('worker log format contract', () => {
