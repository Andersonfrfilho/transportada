...
export const STORAGE_OBJECT_PURPOSES = [
  'import_source',
  'nfe_document',
  'nfe_event',
  'billing_document',
...
export const storedObjects = pgTable(
  ...
  (table) => [
    ...
    check(
      ...
      sql`${table.purpose} in ('import_source', 'nfe_document', 'nfe_event', 'billing_document', 'cte_document', 'mdfe_document', 'nfse_document', 'aggregate_document')`,
    ),
    check(
