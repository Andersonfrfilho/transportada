...
/** `SigAgente` da ANEEL — sigla curta da distribuidora, a mesma que sai impressa na conta de luz. */
export const ENERGY_DISTRIBUTOR_CODE_MAX_LENGTH = 40

/** `NomAgente` — a razão social, que é o que o operador reconhece no select. */
export const ENERGY_DISTRIBUTOR_NAME_MAX_LENGTH = 160
