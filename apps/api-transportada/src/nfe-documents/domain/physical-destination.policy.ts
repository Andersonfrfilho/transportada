...
import {
  buildStopAddressKey,
  type StopAddressComponents,
} from '../../trips/domain/stop-address-key.js'
 ...
 * dois divergem. Tudo que decide *para onde o caminhão vai* segue este seam; quem é o cliente,
 * quem paga e quem é o tomador do frete continua lendo o destinatário.
 */
