 ...
 *
 * Spec 096 T1: a mesma ficha também dá o consumo e o preço do combustível — o que
...
export function createRouteGeometryVehicleAxlesQuery(database: Database): Readonly<{
  /**
   * O eixo, mais o consumo e o preço do combustível do veículo — spec 096 D1: sem os dois, nenhuma
