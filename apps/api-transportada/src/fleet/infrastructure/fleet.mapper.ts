...
export function mapVehicle({ fuelPrices, record }: MapVehicleParams): FleetVehicle {
  ...
  return {
    ...
    loadingAccess: record.loadingAccess,
    brand: record.brand,
    ...
    cargoHeightMeters: formatDecimalAtScale(record.cargoHeightM, MEASURE_SCALE),
    cargoLengthMeters: formatDecimalAtScale(record.cargoLengthM, MEASURE_SCALE),
    cargoWidthMeters: formatDecimalAtScale(record.cargoWidthM, MEASURE_SCALE),
    color: record.color,
...
export function toVehicleColumns(
  ...
  return {
    ...
    cargoHeightM: vehicle.cargoHeightMeters,
