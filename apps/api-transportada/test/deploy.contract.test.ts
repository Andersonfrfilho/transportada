...
import './deploy/keycloak-theme-fork.contract.js'
import './deploy/ntfy.contract.js'
import './deploy/pipeline-change-filter.contract.js'
...
import './deploy/secrets.contract.js'
import './deploy/service-naming.contract.js'
