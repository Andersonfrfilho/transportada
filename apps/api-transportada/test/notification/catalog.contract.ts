...
import { NOTIFICATION_CHANNEL, extractTemplatePlaceholders } from '@adatechnology/notification-contracts'
...
describe('contrato do catálogo de notificações', () => {
  test('as categorias são as quatro do produto e nada além', () => {
