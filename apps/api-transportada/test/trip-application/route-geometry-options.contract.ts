 ...
 *
 * Spec 093 T1: a resposta da rota passa a carregar as alternativas — cada uma com trechos, nós,
 * pedágio e o ranking de `rankRouteOptions` (spec 093 T2) — sem quebrar quem lê hoje `.legs`,
...
describe('opções de rota (spec 093 T1)', () => {
   ...
   * "mais barata" (spec 093 D1). Cada opção soma o **próprio** pedágio (D3), pelos **próprios**
   * nós.
   */
