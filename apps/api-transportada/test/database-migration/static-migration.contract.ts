...
describe('Drizzle migrations', () => {
  test('preserves baseline and identity bytes while versioning additive fiscal migrations', async () => {
    ...
    expect(directories).toEqual([
      ...
      '20260915220000_contractor_mail_sending_verified_at',
      ...
      '20260917143608_toll_booth_extracts',
      ...
      '20260918150100_delivery_proof_punctuality',
      '20260918150200_driver_score_delivered_index',
      ...
      '20260918173348_trip_field_on_behalf_driver_indexes',
      '20260920232745_trip_close_office_authorship',
      '20260921224341_trip_document_occurrence_attachments',
      '20260922024059_package_box_catalog_source',
      '20260922112706_trip_occurrence_attachment_purge_job',
      '20260922114949_job_schedule_pause_control',
      '20260922121307_job_schedule_pause_origin',
      '20260922140709_package_box_unit_and_estimate',
      '20260922164534_trip_document_occurrence_products',
      ...
      '20260922231219_extra_charge_batch_statement',
      '20260923032453_flimsy_metal_master',
      '20260923032744_silent_darkhawk',
      '20260923040021_fine_wendell_rand',
      '20260923051500_trip_status_event_kind',
      '20260923204855_company_occurrence_type_attachment_mode',
      '20260923215639_trip_occurrence_uploads',
      '20260924033423_lumpy_scalphunter',
      '20260924163726_contractor_contact_channels',
      '20260924190850_occurrence_conversations',
