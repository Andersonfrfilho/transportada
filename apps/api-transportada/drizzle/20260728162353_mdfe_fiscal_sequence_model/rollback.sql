...
-- Narrows fiscal_sequences.model back to CT-e only.
...
ALTER TABLE "fiscal_sequences" DROP CONSTRAINT "fiscal_sequences_model_check", ADD CONSTRAINT "fiscal_sequences_model_check" CHECK ("model" in ('cte'));
