CREATE TABLE "energy_tariff_references" (
	...
	"distributor_tax_id" text NOT NULL,
	...
	CONSTRAINT "energy_tariff_references_distributor_check" CHECK (length("distributor_code") > 0 and "distributor_code" = upper("distributor_code") and "distributor_tax_id" ~ '^[A-Z0-9]{12}[0-9]{2}$'),
