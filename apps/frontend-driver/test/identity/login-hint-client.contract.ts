/* Cópia por valor de apps/frontend-client/test/login-hint-client.test.ts (ADR-0075 §7). */
...
describe('resolveLoginHint', () => {
  ...
  beforeEach(() => {
    ...
    process.env.VITE_KEYCLOAK_CLIENT_ID = 'transportada-spa'
