/* Cópia por valor de apps/frontend-transportada/test/notification-smoke.helper.ts (ADR-0075 §7). */
 ...
 * por conta própria, sem passar por nenhum hook nosso. No smoke o frontend é servido fora da
 * allowlist de CORS da API — a chamada volta `net::ERR_FAILED` sem este mock.
 */
