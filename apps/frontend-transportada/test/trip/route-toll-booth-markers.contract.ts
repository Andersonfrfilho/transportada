...
describe('o valor da praça, formatado (spec 096 D3)', () => {
...
describe('as praças do trajeto, com coordenada e rótulo (spec 096 T4)', () => {
...
describe('o desenho da praça do trajeto no mapa (spec 096 T4)', () => {
