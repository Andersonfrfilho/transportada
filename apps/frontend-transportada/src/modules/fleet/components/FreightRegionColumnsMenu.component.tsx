...
import type { FreightRegionColumnsController } from '../hooks/useFreightRegionColumns.hook'
import styles from '../styles/fleet.module.css'

type FreightRegionColumnsMenuProps = Readonly<{ table: FreightRegionColumnsController }>

export function FreightRegionColumnsMenu({ table }: FreightRegionColumnsMenuProps) {
