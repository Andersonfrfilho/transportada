...
/** ADR-0068 §5: faixa de cor da nota — verde ≥80, neutra 50-79, alerta <50. `null` é "sem histórico". */
...
/**
 * Spec 157 RF10, ADR-0068 §7: a nota do motorista (0-100) ou "sem histórico" — usada no seletor de
