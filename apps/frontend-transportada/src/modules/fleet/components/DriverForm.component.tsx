    ...
    <form className={styles.panel} onSubmit={handleSubmit} ref={panelRef}>
      ...
      <fieldset className={styles.fieldGroup}>
        ...
        <div className={styles.fieldGrid}>
          ...
          />
          {/**
           * ⚠️ **Ele muda o desenho da carga, não só a ficha.** Sem cinta a planta para a pilha na
           * altura em que ela tombaria numa curva; com cinta ela sobe até o teto do baú. Por isso o
           * texto de ajuda diz o efeito — um check sem consequência visível não é preenchido.
           */}
