...
/**
 * Spec 159 RF11, ADR-0070 §7: o seletor de motoristas da viagem ordena por nota — da maior para a
 * menor, `null` (sem histórico) sempre por último, e empate pelo nome. Pura e testável sem tela: a
 * ordenação não filtra ninguém, só ordena — a regra é "ordena, não filtra" (ADR-0070 §7).
 */
