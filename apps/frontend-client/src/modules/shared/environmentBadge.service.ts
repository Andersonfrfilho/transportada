...
/**
 * Cópia por valor de `environmentBadge.service.ts` do painel. O elemento é **trocado**, não editado:
 * o navegador já buscou o ícone declarado no HTML, e mudar o `href` dele deixa a aba com a marca de
 * produção até um recarregamento forçado.
 */
