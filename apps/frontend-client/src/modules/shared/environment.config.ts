...
/**
 * Cópia por valor de `isIdentifierFirstLoginEnabled` do painel. **Desligada por padrão**: a
 * ausência da variável mantém o caminho de entrada exatamente como sempre foi.
 *
 * Lida sozinha, e não pelo `getClientEnvironment`, de propósito: uma bandeira que exige a
