...
### 11. MDF-e manual antes de `dispatched` *(059)*
...
### 12. Aprovação do contratante *(060)* → **respondida pela sua decisão do item 15**
...
17. A margem desconta imposto sobre o frete (ICMS, PIS/COFINS)? *Recomendação: não agora — margem
    operacional, dito na tela.*
