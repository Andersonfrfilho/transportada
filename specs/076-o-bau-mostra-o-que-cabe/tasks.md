...
- [ ] **T001** — Contrato de `resolveCargoLayout` (domínio puro): fatia proporcional ao volume de
...
- [ ] **T002** — Implementar a política em `trips/domain/cargo-layout.policy.ts`.
- [ ] **T003** — Expor o layout no detalhe da viagem, ao lado da ocupação.
...
- [ ] **T004** — Contrato de tela: o baú só é desenhado com dimensões conhecidas; a marca de
...
- [ ] **T005** — Componente do baú, em SVG do design system, com a proporção real do veículo (D1).
- [ ] **T006** — Descrição textual equivalente para leitor de tela e impressão. (RNF2 · CA7)
- [ ] **T007** — Responsivo: em 375px vira vista lateral única, sem scroll horizontal; animação
...
- [ ] **T008** — `make check` e smoke verdes, evidência completa.
