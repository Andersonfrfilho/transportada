...
- [ ] **T4** Migration aditiva (`bun run db:generate`, `rollback.sql` escrito), schemas Drizzle, settings
...
- [ ] **T11** Revisão (`code-reviewer`, `security-reviewer` para posição/tenant) + auditoria §15.
