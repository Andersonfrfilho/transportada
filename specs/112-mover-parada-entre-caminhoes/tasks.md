...
- [x] **T2 — Select "Mover para…" por parada, só caminhões com sobra de peso** (D1). Dep: nenhuma.
- [x] **T3 — Movimento como rascunho nos dois caminhões** (D2). Dep: T2.
- [x] **T4 — O aceite manda o movimento** (D3). Dep: T1, T3. ⚠️ API sobe antes do front.
