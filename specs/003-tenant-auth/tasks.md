...
| T013A | Adicionar probe JWKS recuperável e integrar readiness   | T004, T013       | contracts Ada, API health e instalação publicada congelada   | cold start não bloqueia; outage degrada e recuperação volta a ready  | Codex Sol high + aprovação npm   |
...
| T016  | Executar gates finais e revisão independente            | T001–T015, T013A | frozen install, `make check`, integrations e `make smoke`    | evidência completa, sem Railway e sem achado crítico                 | OpenCode free + Codex Sol        |
